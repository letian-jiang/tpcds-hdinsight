...
-- DROP DATABASE IF EXISTS ${PARQUETDBNAME} CASCADE;
CREATE SCHEMA IF NOT EXISTS ${PARQUETDBNAME};
...
create table if not exists call_center WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.call_center;

create table if not exists catalog_page WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.catalog_page;

create table if not exists customer WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.customer;

create table if not exists customer_address WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.customer_address;

create table if not exists customer_demographics WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.customer_demographics;

create table if not exists date_dim WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.date_dim;

create table if not exists household_demographics WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.household_demographics;

create table if not exists income_band WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.income_band;

create table if not exists item WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.item;

create table if not exists promotion WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.promotion;

create table if not exists reason WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.reason;

create table if not exists ship_mode WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.ship_mode;

create table if not exists store WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.store;

create table if not exists time_dim WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.time_dim;

create table if not exists warehouse WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.warehouse;

create table if not exists web_page WITH ( format = 'PARQUET' )
as select * from ${SOURCE}.web_page;

create table if not exists web_site WITH ( format = 'PARQUET' )
